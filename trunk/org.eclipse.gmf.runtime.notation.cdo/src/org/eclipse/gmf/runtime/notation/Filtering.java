...
public final class Filtering extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
	public static final Filtering NONE_LITERAL = new Filtering(NONE, "None", "None"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final Filtering MANUAL_LITERAL = new Filtering(MANUAL, "Manual", "Manual"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final Filtering AUTOMATIC_LITERAL = new Filtering(AUTOMATIC, "Automatic", "Automatic"); //$NON-NLS-1$ //$NON-NLS-2$
