 ...
 * <ul>
 * <li>{@link org.eclipse.emf.ecore.impl2.EModelElementImpl#getEAnnotations <em>
 * EAnnotations</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated not
 */
public abstract class EModelElementImpl extends MinimalEObjectImpl.Container
	...
	public EList getEAnnotations() {
		if (eAnnotations == null) {
			eAnnotations = new EObjectContainmentWithInverseEList(
					...
					EmfPackage.EMODEL_ELEMENT__EANNOTATIONS,
					EmfPackage.EANNOTATION__EMODEL_ELEMENT);
		}
		return eAnnotations;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		switch (featureID) {
		case EmfPackage.EMODEL_ELEMENT__EANNOTATIONS:
