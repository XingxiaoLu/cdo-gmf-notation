...
import org.eclipse.emf.ecore.impl2.EmfPackageImpl;
...
public class NotationPackageImpl extends EPackageImpl implements NotationPackage {
	...
	public static NotationPackage init() {
		...
		EmfPackageImpl theEmfPackage = (EmfPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(EmfPackage.eNS_URI) instanceof EmfPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(EmfPackage.eNS_URI) : EmfPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		EmfPackage theEmfPackage = (EmfPackage)EPackage.Registry.INSTANCE.getEPackage(EmfPackage.eNS_URI);
		...
		viewEClass.getESuperTypes().add(theEmfPackage.getEModelElement());
		...
		addEParameter(op, ecorePackage.getEClass(), "eClass", 0, 1); //$NON-NLS-1$
		...
		initEAttribute(getLineStyle_LineWidth(), ecorePackage.getEInt(), "lineWidth", "-1", 0, 1, LineStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		...
		initEReference(getSortingStyle_SortedObjects(), ecorePackage.getEObject(), null, "sortedObjects", null, 0, -1, SortingStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getView_Element(), ecorePackage.getEObject(), null, "element", null, 0, 1, View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getImage_Data(), ecorePackage.getEByteArray(), "data", null, 0, 1, Image.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getFilteringStyle_FilteredObjects(), ecorePackage.getEObject(), null, "filteredObjects", null, 0, -1, FilteringStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		op = addEOperation(propertiesSetStyleEClass, ecorePackage.getEJavaObject(), "getProperty", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEString(), "propertyName", 0, 1); //$NON-NLS-1$

		op = addEOperation(propertiesSetStyleEClass, ecorePackage.getEBoolean(), "setProperty", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEString(), "propertyName", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEJavaObject(), "newValue", 0, 1); //$NON-NLS-1$

		op = addEOperation(propertiesSetStyleEClass, ecorePackage.getEBoolean(), "createProperty", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEString(), "propertyName", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEDataType(), "instanceType", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEJavaObject(), "initialValue", 0, 1); //$NON-NLS-1$

		op = addEOperation(propertiesSetStyleEClass, ecorePackage.getEBoolean(), "removeProperty", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEString(), "propertyName", 0, 1); //$NON-NLS-1$

		op = addEOperation(propertiesSetStyleEClass, ecorePackage.getEBoolean(), "hasProperty", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEString(), "propertyName", 0, 1); //$NON-NLS-1$

		op = addEOperation(propertiesSetStyleEClass, ecorePackage.getEBoolean(), "createProperty", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEString(), "propertyName", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEString(), "initialValue", 0, 1); //$NON-NLS-1$
		...
		initEAttribute(getStringToPropertyValueMapEntry_Key(), ecorePackage.getEString(), "key", null, 0, 1, Map.Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getPropertyValue_InstanceType(), ecorePackage.getEDataType(), null, "instanceType", null, 0, 1, PropertyValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		addEOperation(propertyValueEClass, ecorePackage.getEJavaObject(), "getValue", 0, 1); //$NON-NLS-1$
		...
		addEOperation(singleValueStyleEClass, ecorePackage.getEJavaObject(), "getValue", 0, 1); //$NON-NLS-1$
		...
		initEAttribute(getListValueStyle_RawValuesList(), ecorePackage.getEString(), "rawValuesList", null, 0, -1, ListValueStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		op = addEOperation(stringObjectConverterEClass, ecorePackage.getEString(), "getStringFromObject", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEJavaObject(), "objectValue", 0, 1); //$NON-NLS-1$

		op = addEOperation(stringObjectConverterEClass, ecorePackage.getEJavaObject(), "getObjectFromString", 0, 1); //$NON-NLS-1$
		addEParameter(op, ecorePackage.getEString(), "stringValue", 0, 1); //$NON-NLS-1$
		...
		initEReference(getDataTypeStyle_InstanceType(), ecorePackage.getEDataType(), null, "instanceType", null, 0, 1, DataTypeStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getEObjectListValueStyle_EObjectListValue(), ecorePackage.getEObject(), null, "eObjectListValue", null, 0, -1, EObjectListValueStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getByteArrayValueStyle_ByteArrayValue(), ecorePackage.getEByteArray(), "byteArrayValue", null, 0, 1, ByteArrayValueStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEAttribute(getHintedDiagramLinkStyle_Hint(), ecorePackage.getEString(), "hint", null, 0, 1, HintedDiagramLinkStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
