...
public final class Sorting extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
	public static final Sorting NONE_LITERAL = new Sorting(NONE, "None", "None"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final Sorting MANUAL_LITERAL = new Sorting(MANUAL, "Manual", "Manual"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final Sorting AUTOMATIC_LITERAL = new Sorting(AUTOMATIC, "Automatic", "Automatic"); //$NON-NLS-1$ //$NON-NLS-2$
