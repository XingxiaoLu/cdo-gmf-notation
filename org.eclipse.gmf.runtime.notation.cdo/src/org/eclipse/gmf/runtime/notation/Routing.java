...
public final class Routing extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
	public static final Routing MANUAL_LITERAL = new Routing(MANUAL, "Manual", "Manual"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final Routing RECTILINEAR_LITERAL = new Routing(RECTILINEAR, "Rectilinear", "Rectilinear"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final Routing TREE_LITERAL = new Routing(TREE, "Tree", "Tree"); //$NON-NLS-1$ //$NON-NLS-2$
