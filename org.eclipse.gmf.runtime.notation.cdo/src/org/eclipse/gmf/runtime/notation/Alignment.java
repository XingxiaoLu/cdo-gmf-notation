...
public final class Alignment extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
	public static final Alignment LEFT_LITERAL = new Alignment(LEFT, "Left", "Left"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final Alignment RIGHT_LITERAL = new Alignment(RIGHT, "Right", "Right"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final Alignment CENTER_LITERAL = new Alignment(CENTER, "Center", "Center"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final Alignment TOP_LITERAL = new Alignment(TOP, "Top", "Top"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final Alignment BOTTOM_LITERAL = new Alignment(BOTTOM, "Bottom", "Bottom"); //$NON-NLS-1$ //$NON-NLS-2$
